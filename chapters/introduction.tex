...
The literature has mainly considered modeling workers abilities and faults \citep{dawid_maximum_1979, raykar_ranking_2011, sinha2018fast,rodrigues2018dee},
XXX ISSUE with a citation here XXX
...
XXX mention the $y_i^\star$ are unknown and one aims at recovering them XXX
...
XXX mention that this could lead to variability in the experiments due to this random choice XXX
More formally:
...
\end{equation}
XXX may be mention the simplest spam case where one uses a dirac, and simply say  cat cat cat etc.XXX
