...
Throughout this thesis, we evaluate our results using different metrics depending on the data available. All of these metrics necessitate true labels $y^\star$ and estimated labels $\hat y$ to be computed.
In \Cref{chap:waum} and \Cref{chap:peerannot}, this ground truth is given by the authors of the datasets. In \Cref{chap:plantnet}, we created and released multiple test sets to evaluate the strategies with ground truth extracted thanks to the participation of $98$ botanical experts to the Pl@ntNet platform.
